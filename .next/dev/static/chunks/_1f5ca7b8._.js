...
function AuthProvider({ children }) {
    ...
    const signIn = async (email, password)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].signIn({
                email,
                password
            });
            setUser(result.user);
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].signOut();
            setUser(null);
        } catch (error) {
...
"[project]/context/city-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(CityProvider, "qqvcytF5pmp3S99cYPUVkrXY5lM=");
_c = CityProvider;
function useCity() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(CityContext);
    if (context === undefined) {
...
_s(AIChatbot, "feTaWksBnD74gQ/NfKh6gGGg/08=");
_c = AIChatbot;
var _c;
...
//# sourceMappingURL=_1f5ca7b8._.js.map
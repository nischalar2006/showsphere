...
function AuthProvider({ children }) {
    ...
    const signUp = async (email, password, fullName)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].signUp({
                email,
                password,
                full_name: fullName
            });
...
//# sourceMappingURL=_b73a7f39._.js.map